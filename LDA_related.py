...
for i in range(len(Test_set)):
    ...
    rank_ = []
    rank_res = []#1,2,3,4,5,10,20,30,40,50
    ...
    for r in [1,2,3,4,5,10,20,30,40,50]:
        t = 0
        for j in range(len(gt)):
            if j<len(rank_) and rank_[j]<=r:
                t+=float(j+1)/rank_[j]
            else:
                t+=0
        t = t/len(gt)
    ...
    rank_1.append(rank_res[0])
    rank_2.append(rank_res[1])
    rank_3.append(rank_res[2])
    rank_4.append(rank_res[3])
    rank_5.append(rank_res[4])
    rank_10.append(rank_res[5])
    rank_20.append(rank_res[6])
    rank_30.append(rank_res[7])
    rank_40.append(rank_res[8])
    rank_50.append(rank_res[9])
...
tmp = []
tmp.append(float(sum(rank_1))/(len(p_1)-c))
tmp.append(float(sum(rank_2))/(len(p_2)-c))
tmp.append(float(sum(rank_3))/(len(p_3)-c))
tmp.append(float(sum(rank_4))/(len(p_4)-c))
tmp.append(float(sum(rank_5))/(len(p_5)-c))
tmp.append(float(sum(rank_10))/(len(p_10)-c))
tmp.append(float(sum(rank_20))/(len(p_20)-c))
tmp.append(float(sum(rank_30))/(len(p_30)-c))
tmp.append(float(sum(rank_40))/(len(p_40)-c))
tmp.append(float(sum(rank_50))/(len(p_50)-c))
print "mean rank:"
print tmp
'''
